...
class CarMapperStaticTest {
    ...
    void toEntity(){
        ...
        Car entity = CarMapperStatic.INSTANCE.toEntity(carDTO, companyDTO, reservationDTO, "테스트메모", "테스트파라미터");
    ...
    void toDto(){
        ...
        CarDto dto = CarMapperStatic.INSTANCE.toDto(car);
